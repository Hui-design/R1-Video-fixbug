...
## What is the bug?
In lines 444-453 of Open-R1-Video/src/open_r1_video/trainer/grpo_trainer.py, both the current model ($$\pi_{\theta}$$) and ref_model ($$\pi_{ref}$$) require passing through the get_per_token_logps function to execute a forward function of the model and obtain log probabilities. 
...
- However, in the implementations of both Open-R1-Video and open-r1-multimodal, the inputs differ. Specifically, the reference model (ref_model) lacks the **prompt_inputs argument.

<div align='center'>
<img src="assets/fig2.png" style="width: 70%">
</div> 

- We further verified the implementation in R1-V and confirmed that the inputs to model and ref_model are indeed identical

<div align='center'>
<img src="assets/fig3.png" style="width: 90%">
</div> 
